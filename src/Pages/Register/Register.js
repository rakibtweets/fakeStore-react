          ...
          <div className="md:flex justify-center w-full">
            ...
            <div className="w-3/4  py-10 px-5 md:px-10">
              ...
              <div>
                ...
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-5">
                    <button type="button" className="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold active:scale-95 duration-150">REGISTER NOW</button>
                  </div>
                </div>
              </div>
            </div>
